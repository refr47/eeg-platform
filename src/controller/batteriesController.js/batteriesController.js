...
import BatteryState from "../models/BatteryState";
import EnergyPolicy from "../models/EnergyPolicy";
...
export { getBatteryById };
export { listBatteries };
export { createBatteryState };
export { listBatteryStates };
export { createEnergyPolicy };
export { listEnergyPolicies };
export default {
  createBattery,
  getBatteryById,
  listBatteries,
